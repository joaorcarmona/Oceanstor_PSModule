...
$validationModule = New-Module -Name OceanstorLiveGetterValidation -ArgumentList $moduleRoot -ScriptBlock {
    ...
    foreach ($privateHelper in @(
        ...
        'Resolve-DMHyperCDPLun.ps1',
        'Resolve-DMHyperCDPSchedule.ps1',
